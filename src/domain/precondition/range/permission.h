...
public:
  explicit permission_precondition_range_save(CombineContext *context) : Permission(context) {};
...
public:
  explicit permission_precondition_range(CombineContext *context) : Permission(context) {};
