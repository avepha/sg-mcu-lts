...
#ifndef SG_MCU_CONTINUOUS_TIMER_PERMISSION_H
#define SG_MCU_CONTINUOUS_TIMER_PERMISSION_H

class permission_continuous_timer_save : public Permission {
public:
  explicit permission_continuous_timer_save() : Permission() {};
...
#endif //SG_MCU_CONTINUOUS_TIMER_PERMISSION_H
