...
#ifndef SG_MCU_CONTINUOUS_RANGE_PERMISSION_H
#define SG_MCU_CONTINUOUS_RANGE_PERMISSION_H

class permission_continuous_range_save : public Permission {
public:
  explicit permission_continuous_range_save() : Permission() {};
...
#endif //SG_MCU_CONTINUOUS_RANGE_PERMISSION_H
