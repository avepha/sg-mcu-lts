...
#ifndef SG_MCU_CONTINUOUS_RANGE_RESOLVERS_H
#define SG_MCU_CONTINUOUS_RANGE_RESOLVERS_H

// @mutation
class mutation_continuous_range_save : public Mutation {
public:
  explicit mutation_continuous_range_save() : Mutation("continuous_range_save", new permission_continuous_range_save()) {};

  JsonDocument resolve(JsonObject reqData, CombineContext *context) override {
    JsonObject range = reqData["range"];
    ContinuousRangeSchema schema = context->continuousRange->model->get();
    ...
    int writeOps = context->continuousRange->model->save(schema);
    ContinuousRangeSchema newSchema = context->continuousRange->model->get();
...
// @query: date
class query_continuous_range : public Query {
public:
  explicit query_continuous_range() : Query("continuous_range") {};
...
#endif //SG_MCU_CONTINUOUS_RANGE_RESOLVERS_H
