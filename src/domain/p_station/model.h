...
#ifndef SG_MCU_PSTATION_MODEL_H
#define SG_MCU_PSTATION_MODEL_H

struct PStationSchema {
...
class PStationModel : public RomModel<PStationSchema> {
public:
  PStationModel() : RomModel("PStationModel") {};

  void initModel() override {
    PStationSchema schema;
    schema.stationSize = 2;
    schema.stations[0].type = PSTATION_GSENSOR;
    ...
    schema.stations[1].type = PSTATION_SOLUTION;
